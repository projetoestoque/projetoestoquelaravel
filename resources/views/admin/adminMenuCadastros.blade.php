...
<div class="row">
<div class="col l12">
    <a href="{{route('admin.listarCadastros')}}" class="black-text">
        ...
        <div class="mobile-hide"><div class="row"></div></div>
            ...
            <h5><b>Visualisar Cadastros</b><div class="mobile-hide"> <i class="material-icons small right">send</i></div></h5>          
            </div>
        </div>
        </div>
    </a>
...
<div class="col l12">
    ...
    <div class="card-image-fade">
      ...
      <div class="mobile-hide"><div class="row"></div></div>
        <div class="card-content white">
          <h5><b>Novo Cadastro</b> <div class="mobile-hide"><i class="material-icons small right">send</i></div></h5>
        </div>
      </div>
    </div>
    </a>
